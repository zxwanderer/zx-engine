...
- после вывода сообщения об окончании игры надо нажать клавишу G для перехода в меню, надеюсь это предотвратит спонтанные переходы в меню после нажатия клавиш по инерции
(!) нажимать FX при нажатии клавиш в сообщениях об окончании игры
