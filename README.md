...
- для симметричности расположения дверей в комнату начальника добавлена замаскированая решетка, внезапно оказалось что это дает еще один шанс попасть в нее, если электроника у двери комнаты случайно поломалась от удара чем-то тяжелым
- боевой скафандр перекрашен в зеленый цвет :)

(?) при попытке надеть скафандр когда уже один из скафандров надет - выдавать сообщение "вы уже в скафандре"
(?) при хороших финалах игры выдавать одно общее сообщение и одно в зависимости от финала
(?) восстановить сообщение ЦЕРБЕРА хотя бы в виде планшета
(?) выдавать сообщение о слишком легком скафандре и далеко от базы при пересечении 0-х координат или выхода за пределы карты
