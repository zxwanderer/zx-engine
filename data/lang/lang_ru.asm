...
HELLO_TXT:
  ...
  db "Из названия процедуры следует, что адрес находится в регистровой паре HL. "
  ; db "Также используются варианты этой процедуры для других регистровых пар. Существует несколько версий процедуры, "
